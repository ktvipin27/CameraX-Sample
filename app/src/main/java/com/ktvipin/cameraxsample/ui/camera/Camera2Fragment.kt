...
class Camera2Fragment : Fragment(R.layout.fragment_camera2), ControlView.Listener {
    ...
    inner class ImageSavedCallback(private val photoFile: File) :
        ...
        override fun onImageSaved(output: ImageCapture.OutputFileResults) {
            ...
            findNavController()
                .navigate(Camera2FragmentDirections.actionCamera2FragmentToPreviewFragment(savedUri))
        }
    ...
    override fun onResume() {
        ...
        if (!PermissionFragment.hasPermissions(requireContext()))
            findNavController()
                .navigate(Camera2FragmentDirections.actionCamera2FragmentToPermissionFragment())
    }
